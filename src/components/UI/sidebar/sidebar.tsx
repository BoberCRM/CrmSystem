...
const Sidebar: React.FC = () => {
  ...
  return (
    <div className={`${styles.sidebar_container}`}>
      <Button onClick={toggleSidebar} type="circle" variant="primary" iconSrc={isOpen} label={'btn'}> btn</Button>
        ...
        <ul className={styles.sidebarList}>
          <li className={styles.sidebarListItem}>
            <Link href="/home" className={styles.sidebarListItemLink}>
              <span className={styles.sidebarListItemIcon}> 
                <Image src={HomeIcon} height={30} width={30} alt={'image'}/>
              </span>
          ...
          <li className={styles.sidebarListItem}>
            <Link href="/data" className={styles.sidebarListItemLink}>
              <span className={styles.sidebarListItemIcon}> 
                <Image src={DataIcon} height={30} width={30} alt={'image'}/>
              </span>
              {/* { isOpen == arrowRight && } */}
          ...
          <li className={styles.sidebarListItem}>
            <Link href="/statistic" className={styles.sidebarListItemLink}>
              <span className={styles.sidebarListItemIcon}> 
                <Image src={StaticIcon} height={30} width={30} alt={'image'}/>
              </span>
              {/* { isOpen == arrowRight && } */}
          ...
          <li className={styles.sidebarListItem}>
            <Link href="/settings" className={styles.sidebarListItemLink}>
              <span className={styles.sidebarListItemIcon}> 
                <Image src={Settings} height={30} width={30} alt={'image'}/>
              </span>
              {/* { isOpen == arrowRight && } */}
