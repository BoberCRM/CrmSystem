"use client";  // Директива для использования клиента
        ...
        <ul className={styles.sidebarList}>
          <li className={styles.sidebarListItem}>
            <Link href="/home" className={styles.sidebarListItemLink}>
              <span className={styles.sidebarListItemIcon}> 
                <Image src={HomeIcon} height={30} width={30} alt={'text'} color='#181818'/>
              </span>
          ...
          <li className={styles.sidebarListItem}>
            <Link href="/data" className={styles.sidebarListItemLink}>
              <span className={styles.sidebarListItemIcon}> 
                <Image src={DataIcon} height={30} alt={'text'} width={30}/>
              </span>
              {/* { isOpen == arrowRight && } */}
              <span className={styles.sidebarListItemLink_span}>Данные</span>
              {/* <SvgComponentData height={30} width={30}/> */}
            </Link>
          </li>
          <li className={styles.sidebarListItem}>
            <Link href="/statistic" className={styles.sidebarListItemLink}>
              <span className={styles.sidebarListItemIcon}> 
                <Image src={StaticIcon} height={30} alt={'text'} width={30}/>
              </span>
              {/* { isOpen == arrowRight && } */}
          ...
          <li className={styles.sidebarListItem}>
            <Link href="/settings" className={styles.sidebarListItemLink}>
              <span className={styles.sidebarListItemIcon}> 
                <Image src={Settings} height={30}  alt={'text'} width={30}/>
              </span>
              {/* { isOpen == arrowRight && } */}
